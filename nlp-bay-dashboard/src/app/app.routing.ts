...
const routes: Routes = [
  // Login
  {
    path: "login",
    loadChildren: () =>
      import("app/auth/signin/signin.module").then((m) => m.SigninModule),
  },
  ...
  // RESET PASSORD (i.e. page forgot psw & reset psw )
  {
    path: "forgotpsw",
    loadChildren: () =>
      import("app/reset-psw/reset-psw.module").then((m) => m.ResetPswModule),
  },
  ...
  // CHANGE PSWRD if project is defined (use case: THE USER SELECTED A PROJECT)
  {
    ...
    loadChildren: () =>
      import("app/user-profile/change-password/change-password.module").then(
  ...
  // Pricing
  {
    ...
    loadChildren: () =>
      import("app/pricing/pricing.module").then((m) => m.PricingModule),
  ...
  // { path: 'project/:projectid/chat-pricing', component: PricingComponent, canActivate: [AuthGuard] }, // now Lazy
  {
    ...
    loadChildren: () =>
      import("app/pricing/payments-list/payments-list.module").then(
        (m) => m.PaymentsListModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner"] }],
  },
  // { path: 'project/:projectid/payments', component: PaymentsListComponent, canActivate: [AuthGuard] }, // now Lazy
  {
    ...
    loadChildren: () =>
      import("app/pricing/payment-success-page/payment-success.module").then(
  ...
  // { path: 'success', component: PaymentSuccessPageComponent, canActivate: [AuthGuard] }, // now Lazy
  {
    ...
    loadChildren: () =>
      import("app/pricing/payment-canceled-page/payment-canceled.module").then(
        (m) => m.PaymentCanceledModule
      ),
    canActivate: [AuthGuard],
  },
  ...
  // CDS
  {
    ...
    loadChildren: () =>
      import("app/chatbot-design-studio/chatbot-design-studio.module").then(
        (m) => m.ChatbotDesignStudioModule
      ),
    canActivate: [AuthGuard, RoleGuard],
  ...
  // Activities demo page
  {
    ...
    loadChildren: () =>
      import(
        "app/static-pages/activities-static/activities-static.module"
      ).then((m) => m.ActivitiesStaticModule),
    canActivate: [AuthGuard],
  },
  ...
  // Analytics
  {
    ...
    loadChildren: () =>
      import("app/analytics/analytics.module").then((m) => m.AnalyticsModule),
    canActivate: [AuthGuard],
  },
  // { path: 'project/:projectid/analytics', component: AnalyticsComponent, canActivate: [AuthGuard] }, // now lazy
  ...
  // { path: 'project/:projectid/analytics/metrics', component: AnalyticsComponent, canActivate: [AuthGuard] }, // now lazy
  ...
  // { path: 'project/:projectid/analytics/metrics/visitors', component: AnalyticsComponent, canActivate: [AuthGuard] }, // now lazy
  ...
  // { path: 'project/:projectid/analytics/metrics/messages', component: AnalyticsComponent, canActivate: [AuthGuard] }, // now lazy

  // Analytics demo page
  {
    path: "project/:projectid/analytics-demo",
    loadChildren: () =>
      import("app/static-pages/analytics-static/analytics-static.module").then(
        (m) => m.AnalyticsStaticModule
      ),
    canActivate: [AuthGuard],
  },
  ...
  // Apps
  {
    ...
    loadChildren: () =>
      import("app/app-store/app-store.module").then((m) => m.AppStoreModule),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
...

  {
    ...
    loadChildren: () =>
      import("app/app-store/app-store-install/app-store-install.module").then(
        (m) => m.AppStoreInstallModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
...

  {
    ...
    loadChildren: () =>
      import("app/app-store/app-create/app-create.module").then(
        (m) => m.AppCreateModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  ...
  // Contacts
  {
    ...
    loadChildren: () =>
      import("app/contacts/contacts.module").then((m) => m.ContactsModule),
    canActivate: [AuthGuard],
  },
  //  { path: 'project/:projectid/contacts', component: ContactsComponent, canActivate: [AuthGuard] },  // now lazy

  {
    path: "project/:projectid/contact/:requesterid",
    loadChildren: () =>
      import("app/contact-details/contact-details.module").then(
...

  {
    ...
    loadChildren: () =>
      import("app/contact-edit/contact-edit.module").then(
        (m) => m.ContactEditModule
      ),
    canActivate: [AuthGuard],
  },
  ...
  // Contacts demo page
  {
    ...
    loadChildren: () =>
      import("app/static-pages/contacts-static/contacts-static.module").then(
        (m) => m.ContactsStaticModule
      ),
    canActivate: [AuthGuard],
  },
  ...
  // Conversation details
  {
    ...
    loadChildren: () =>
      import("app/ws_requests/ws-requests-msgs/ws-requests-msgs.module").then(
        (m) => m.WsRequestsMsgsModule
      ),
    canActivate: [AuthGuard],
  },
  ...
  // Conversations list  (Served - Unserved)
  {
    ...
    loadChildren: () =>
      import("app/ws_requests/ws-requests-list/ws-requests-list.module").then(
        (m) => m.WsRequestsListModule
      ),
    canActivate: [AuthGuard],
  },
  ...
  // { path: 'project/:projectid/wsrequests', component: WsRequestsListComponent, canActivate: [AuthGuard] }, // now lazy
  ...
  // Conversations list demo page
  {
    ...
    loadChildren: () =>
      import(
        "app/static-pages/wsrequests-static/wsrequests-static.module"
      ).then((m) => m.WsrequestsStaticModule),
    canActivate: [AuthGuard],
  },
  ...
  // HISTORY & NORT
  {
    ...
    loadChildren: () =>
      import(
        "app/ws_requests/history-and-nort-convs/history-and-nort-convs.module"
      ).then((m) => m.HistoryAndNortConvsModule),
    canActivate: [AuthGuard],
  },
  ...
  // Unserved for chat ionic
  {
    ...
    loadChildren: () =>
      import(
        "app/ws_requests/for-panel/ws-requests-unserved-for-panel/ws-requests-unserved-for-panel.module"
      ).then((m) => m.WsRequestsUnservedForPanelModule),
    canActivate: [AuthGuard],
  },
  ...
  // Canned Responses
  {
    ...
    loadChildren: () =>
      import("app/canned-responses/canned-responses-list.module").then(
        (m) => m.CannedResponsesListModule
      ),
    canActivate: [AuthGuard],
  },
  ...
  // Canned Responses demo page
  {
    ...
    loadChildren: () =>
      import(
        "app/static-pages/canned-responses-static/canned-responses-static.module"
      ).then((m) => m.CannedResponsesStaticModule),
    canActivate: [AuthGuard],
  },
  ...
  // Widget Set Up
  {
    ...
    loadChildren: () =>
      import("app/widget_components/widget-set-up/widget-set-up.module").then(
        (m) => m.WidgetSetUpModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  // Widget Multilanguage
  {
    ...
    loadChildren: () =>
      import(
        "app/widget_components/widget-multilanguage/widget-multilanguage.module"
      ).then((m) => m.WidgetMultilanguageModule),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  // Widget installation
  {
    ...
    loadChildren: () =>
      import("app/widget-installation/widget-installation.module").then(
        (m) => m.WidgetInstallationModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  // Departments
  {
    ...
    loadChildren: () =>
      import("app/departments/departments.module").then(
  ...
  // Department Create
  {
    ...
    loadChildren: () =>
      import("app/department-edit-add/department-edit-add.module").then(
        (m) => m.DepartmentEditAddModule
      ),
    canActivate: [AuthGuard],
    // ,
  ...
  // Departments demo page
  {
    ...
    loadChildren: () =>
      import(
        "app/static-pages/departments-static/departments-static.module"
      ).then((m) => m.DepartmentsStaticModule),
    canActivate: [AuthGuard],
  },
  ...
  // Add Teammate
  {
    ...
    loadChildren: () =>
      import("app/user-edit-add/user-edit-add.module").then(
        (m) => m.UserEditAddModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  // Group create
  {
    ...
    loadChildren: () =>
      import("app/group-edit-add/group-edit-add.module").then(
        (m) => m.GroupEditAddModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  // Group demo page
  {
    ...
    loadChildren: () =>
      import("app/static-pages/groups-static/groups-static.module").then(
        (m) => m.GroupsStaticModule
      ),
    canActivate: [AuthGuard],
  },
  ...
  // Email ticketing
  {
    ...
    loadChildren: () =>
      import("app/email-ticketing/email-ticketing.module").then(
        (m) => m.EmailTicketingModule
      ),
    canActivate: [AuthGuard],
  },
  // { path: 'project/:projectid/email', component: EmailTicketingComponent, canActivate: [AuthGuard] }, // now lazy
  ...
  // Email ticketing demo page
  {
    ...
    loadChildren: () =>
      import(
        "app/static-pages/email-ticketing-static/email-ticketing-static.module"
      ).then((m) => m.EmailTicketingStaticModule),
    canActivate: [AuthGuard],
  },
  ...
  // Tags
  {
    ...
    loadChildren: () =>
      import("app/tags/tags.module").then((m) => m.TagsModule),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  // Working hours
  {
    ...
    loadChildren: () =>
      import("app/hours/hours.module").then((m) => m.HoursModule),
    canActivate: [AuthGuard],
  },
  // { path: 'project/:projectid/hours', component: HoursComponent, canActivate: [AuthGuard] }, // now lazy

  // Working hours demo page
  {
    path: "project/:projectid/hours-demo",
    loadChildren: () =>
      import("app/static-pages/hours-static/hours-static.module").then(
        (m) => m.HoursStaticModule
      ),
    canActivate: [AuthGuard],
  },
  ...
  // Automations
  {
    ...
    loadChildren: () =>
      import("app/automations/automations.module").then(
        (m) => m.AutomationsModule
      ),
    canActivate: [AuthGuard],
  },
  // { path: 'project/:projectid/automations', component: AutomationsComponent, canActivate: [AuthGuard] }, // now lazy
  ...
  // Automations demo page
  {
    ...
    loadChildren: () =>
      import(
        "app/static-pages/automation-static/automation-static.module"
      ).then((m) => m.AutomationStaticModule),
    canActivate: [AuthGuard],
  },
  ...
  // Integrations
  {
    ...
    loadChildren: () =>
      import("app/integrations/integrations.module").then(
  ...
  // Project edit / add - General
  {
    ...
    loadChildren: () =>
      import("app/project-edit-add/project-edit-add.module").then(
        (m) => m.ProjectEditAddModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  // Project edit / add - Customize the notification email templates
  {
    ...
    loadChildren: () =>
      import(
        "app/project-edit-add/notification-email/notification-email.module"
      ).then((m) => m.NotificationEmailModule),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner"] }],
  },
  ...
  // Project edit / add - SMTP settings
  {
    ...
    loadChildren: () =>
      import("app/project-edit-add/smtp-settings/smtp-settings.module").then(
        (m) => m.SmtpSettingsModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner"] }],
  },
  ...
  // Project edit / add - Webhook
  {
    ...
    loadChildren: () =>
      import("app/webhook/webhook.module").then((m) => m.WebhookModule),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  // Trigger demo page
  {
    ...
    loadChildren: () =>
      import("app/static-pages/trigger-static/trigger-static.module").then(
        (m) => m.TriggerStaticModule
      ),
    canActivate: [AuthGuard],
  },
  ...
  // ---------------------------------------
  {
    ...
    loadChildren: () =>
      import(
        "app/knowledge-bases-previous/knowledge-bases-previous.module"
      ).then((m) => m.KnowledgeBasesPreviousModule),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  // ---------------------------------------
  {
    ...
    loadChildren: () =>
      import("app/knowledge-bases/knowledge-bases.module").then(
  ...
  {
    path: "project/:projectid/bots/create/:type/:template",
...

  {
    ...
    loadChildren: () =>
      import("app/bots/bots-list/bots-list.module").then(
        (m) => m.BotsListModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  ...
  {
    path: "project/:projectid/bots/create/:type",
    component: BotCreateComponent,
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  // Chatbots demo page
  {
    ...
    loadChildren: () =>
      import("app/static-pages/bots-static/bots-static.module").then(
        (m) => m.BotsStaticModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  // ---------------------------
  {
    ...
    loadChildren: () =>
      import("app/bots/templates/templates.module").then(
        (m) => m.TemplatesModule
      ),
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  ...
  {
    path: "project/:projectid/template-details/:templateid",
    component: CommunityTemplateDtlsComponent,
    canActivate: [AuthGuard, RoleGuard],
    data: [{ roles: ["owner", "admin"] }],
  },
  ...
  {
    path: "project/:projectid/bots/:faqkbid/:type",
  ...
  // Unathorized page - Token not valid
  {
    path: "invalid-token",
    loadChildren: () =>
      import("app/auth/unauthorized-token/unauthorized-token.module").then(
        (m) => m.UnauthorizedTokenModule
      ),
  },
  ...
  {
    path: "get-chatbot/:botid",
    component: GetStartChatbotForkComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "activate-product/:activation_email/:licenseproductkeyuuid/:plan_id/:invoice_item_uuid",
    component: ActivateAppsumoProductComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "install-template/:botid/:projectid",
    component: InstallTemplateComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "install-template-np/:botid/:projectid/:langcode/:langname",
    component: InstallTemplateComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "create-project-itw/:botid",
    component: CreateProjectComponent,
    canActivate: [AuthGuard],
  }, // wizard
  {
    path: "create-project-gs",
    component: CreateProjectGsComponent,
    canActivate: [AuthGuard],
  },
  ...
  }, // wizard
  {
    ...
    component: OnboardingContentComponent,
    canActivate: [AuthGuard],
  }, // wizard
  {
    path: "project/:projectid/onboarding-widget",
    component: OnboardingWidgetComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "project/:projectid/desktop-access/:botid",
    component: CnpIsMobileComponent,
    canActivate: [AuthGuard],
  }, // wizard
  {
    path: "project/:projectid/desktop--access/:namespaceid",
    component: CnpIsMobileComponent,
    canActivate: [AuthGuard],
  }, // wizard
  {
    path: "project/:projectid/onboarding-templates",
    component: CnpTemplatesComponent,
    canActivate: [AuthGuard],
  }, // wizard

  {
    path: "project/:projectid/configure-widget",
    component: ConfigureWidgetComponent,
    canActivate: [AuthGuard],
  }, // wizard step 2
  {
    path: "project/:projectid/onboarding/:langcode/:langname",
    component: OnboardingComponent,
    canActivate: [AuthGuard],
  }, // wizard step 3
  {
    path: "project/:projectid/install-widget/:langcode/:langname",
    component: InstallWidgetComponent,
    canActivate: [AuthGuard],
  },
  ...
  {
    path: "handle-invitation/:pendinginvitationid/:projectname/:adminfirstname/:adminsurname",
    component: HandleInvitationComponent,
  },
  // added to resolve the error Cannot match any routes when the surname is not available
  {
    path: "handle-invitation/:pendinginvitationid/:projectname/:adminfirstname",
    component: HandleInvitationComponent,
  },
  ...
  {
    path: "project/:projectid/unauthorized-access",
    component: UnauthorizedForPricingComponent,
  },
  {
    path: "project/:projectid/unauthorized_access",
    component: UnauthorizedForProjectComponent,
  },
  ...
  {
    path: "project/:projectid/user-profile",
    component: UserProfileComponent,
    canActivate: [AuthGuard],
  },
  ...
  {
    path: "project/:projectid/wsrequest/loading",
  ...
  // TRIGGER
  {
    path: "project/:projectid/trigger",
    component: TriggerComponent,
    canActivate: [AuthGuard],
  },

  {
    path: "project/:projectid/trigger/add",
    component: TriggerAddComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "project/:projectid/trigger/:triggerId",
    component: TriggerEditComponent,
    canActivate: [AuthGuard],
  },
  ...
  {
    path: "project/:projectid/user/:userid/settings",
  ...
  {
    path: "project/:projectid/user/:userid/notifications",
  ...
  {
    path: "project/:projectid/visitors",
    component: VisitorsComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "project/:projectid/events/:requesterid",
...
@NgModule({
  ...
  providers: [AuthGuard, AdminGuard, RoleGuard],
})
